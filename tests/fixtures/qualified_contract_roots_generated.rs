...
pub struct Bridge {
    pub input: signal_lojix::Input,
    pub output: meta_signal_lojix::Output,
}
...
#[rustfmt::skip]
impl Input {
    pub fn observe(payload: Bridge) -> Self {
...
#[rustfmt::skip]
impl Output {
    pub fn observed(payload: Bridge) -> Self {
        Self::Observed(payload)
    }
}

#[rustfmt::skip]
impl From<Bridge> for Input {
    fn from(payload: Bridge) -> Self {
        Self::Observe(payload)
    }
}

#[rustfmt::skip]
impl From<Bridge> for Output {
    fn from(payload: Bridge) -> Self {
        Self::Observed(payload)
    }
}
...
impl signal_frame::SignalOperationHeads for Input {
    const HEADS: &'static [&'static str] = &["Observe"];
}
#[rustfmt::skip]
