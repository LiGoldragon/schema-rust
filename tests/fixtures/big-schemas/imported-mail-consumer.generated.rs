...
impl signal_frame::SignalOperationHeads for Input {
    const HEADS: &'static [&'static str] = &["Record", "Observe", "Mark", "Commit"];
}
#[rustfmt::skip]
        ...
        match self {
            Self::Input(route) => {
                match route {
                    ...
                    InputRoute::Mark => "SignalInputMark",
                    InputRoute::Commit => "SignalInputCommit",
                }
            }
            Self::Output(route) => {
                match route {
                    ...
                    OutputRoute::Marked => "SignalOutputMarked",
                    OutputRoute::Committed => "SignalOutputCommitted",
