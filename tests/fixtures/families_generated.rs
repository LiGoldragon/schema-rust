...
pub mod family_identity {
    pub const ENTRY_FAMILY: [u8; 32] = [
        21, 207, 44, 217, 180, 121, 177, 11, 131, 210, 3, 193, 120, 43, 220, 179, 119,
        232, 76, 235, 215, 41, 248, 34, 243, 125, 209, 52, 218, 195, 93, 187,
    ];
    pub const OBSERVATION_FAMILY: [u8; 32] = [
        139, 162, 14, 175, 234, 85, 152, 183, 252, 39, 239, 235, 12, 196, 182, 211, 218,
        202, 34, 111, 201, 130, 10, 36, 205, 120, 129, 168, 133, 20, 161, 146,
    ];
}
