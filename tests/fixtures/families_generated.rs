...
pub mod family_identity {
    pub const ENTRY_FAMILY: [u8; 32] = [
        166, 45, 203, 10, 146, 152, 134, 185, 15, 164, 219, 130, 236, 214, 6, 189, 160,
        122, 254, 20, 237, 62, 153, 8, 213, 44, 247, 2, 133, 31, 132, 201,
    ];
    pub const OBSERVATION_FAMILY: [u8; 32] = [
        231, 173, 145, 182, 217, 240, 59, 137, 181, 158, 42, 153, 14, 44, 99, 113, 226,
        181, 158, 57, 30, 4, 131, 88, 59, 123, 181, 43, 40, 60, 49, 72,
    ];
}
